...
import { addUsuariosToDireccion, createDireccion, deleteDireccion, getDireccionById, getDirecciones, getDireccionesByUserId, getEnabledDirecciones, toggleEnabled, updatedDireccion } from '../controllers/direccionController'
...
router.post('/:direccionId/usuarios', authenticateToken, addUsuariosToDireccion)
